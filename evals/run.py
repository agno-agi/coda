...
Unified runner for all Coda eval categories.
    ...
    for i, case in enumerate(cases, 1):
        ...
        try:
            ...
            eval_obj = AccuracyEval(
                name=f"Exploration: {question[:40]}",
                input=question,
            ...
            passed = (
                ...
                and eval_result.avg_score is not None
                and eval_result.avg_score >= 7.0
            )
            result: dict = {
                "question": question,
                "category": category,
